...
import robot from "../public/lf20_GbabwrUY2k.json";
...
async function speakAnswer(answer: string): Promise<string> {

  const synth = window.speechSynthesis
  const ssu = new SpeechSynthesisUtterance(answer)
  synth.speak(ssu)
...
export default function Main() {
    ...
    const [context, setContext] = useState([
        {
            role: "user",
            content: " I am a 10 year-old student. My English skill is weak. Let imagine that you are my English teacher and you are older than me. You are trying to help me improve my speaking skill by talking to me. So just use words that you think is at my level for answering and making question. Remember this is likely a daily conversation so don't talk too much. An answer may be just 1-5 lines."
        },
    ])
    ...
    const stopListening = async () => {
      ...
      const answer = await getAnswer(currentContext)
      resetTranscript()
      setAnswer(answer)
      setContext(oldContext=>[...oldContext, {
        role:'assistant', 
        content: answer
      }])
    ...
    useEffect(() => {
      let timer:any;
      if (transcript ) {
        timer = setTimeout(stopListening, 5000); // Delay of 5 seconds before automatically stopping recognize
    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          {/* Section header */}
          <Lottie data-aos="fade-up" animationData={robot} style={{height: 200}} />
